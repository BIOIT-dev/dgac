                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table name="tabla_asistencias" id="tabla_asistencias" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <tbody>
											<?php foreach($asistencias_alumno as $asistencia) { ?>
                                            <tr>
                                                <td scope="col"><?php echo $asistencia->oid ?></td>
                                                <td scope="col"><?php echo $asistencia->asis_fecha ?></td>
                                                <td scope="col"><?php echo $asistencia->asis_horas ?></td>
                                                <td scope="col"><?php echo ($asistencia->asus_presente == 1)?'Sí':'No'; ?></td>
                                                <td scope="col"><?php echo ($asistencia->asus_atrasado == 1)?'Sí':'No'; ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>

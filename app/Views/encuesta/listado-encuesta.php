...
<body>
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('encuesta/buscar_encuesta'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            ...
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->titulo ?>', tipo_encuesta, 
    ...
    <script>
        function modalSwal(){ 
            cant_encuestas_checked = $('#tabla_encuesta').DataTable().column(0).checkboxes.selected().length;
            if (cant_encuestas_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_encuestas_checked+" encuestas/preguntas? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar(){
            var checked = {};
            var list_checked = $('#tabla_encuesta').DataTable().column(0).checkboxes.selected();
            for (var i = 0; i < list_checked.length; i++){
                checked[i] = list_checked[i];
            }
            var url = "<?php echo base_url('public/encuesta/eliminar_encuesta'); ?>";

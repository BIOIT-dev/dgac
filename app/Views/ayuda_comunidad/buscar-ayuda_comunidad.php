                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" name="ayuda_comunidad_search" id="ayuda_comunidad_search" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="userid" class="col-sm-3 text-right control-label col-form-label">Nombre de Comunidad</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre Comunidad">
                                        </div>
                                    </div>
                                </div>
                                <hr>
    ...
    <script type='text/javascript'>
        $(document).ready(function(){
            ...
            $('#user_search').onsubmit(function(){
                ...
                $.ajax({
                    url:'<?php echo base_url('public/carrera/buscar_carrera'); ?>',
                    method: 'post',

...
<body>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                            ...
                                            ?>
                                        <form action="<?php echo base_url('public/Acceso/editar_acceso/'.$acceso_data_edit[0]->rol.";".$acceso_data_edit[0]->oid_grupo); ?>" name="crear_acceso" id="crear_acceso" method="post" accept-charset="utf-8" class="form-horizontal form-material">
                                            <input type="hidden" name="id" value="<?php echo $acceso_data_edit[0]->rol.";".$acceso_data_edit[0]->oid_grupo; ?>">
                                        ...
                                        <input type="hidden" id="value_role" value="<?php echo $acceso_data_edit[0]->rol; ?>">
                                        <input type="hidden" id="value_grupo" value="<?php echo $acceso_data_edit[0]->oid_grupo; ?>">
                                        <input type="hidden" id="value_usuario_ids" value="<?php echo $acceso_data_edit[0]->usuario_ids; ?>">
                                    </div> 
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var value_role = $("#value_role").val();
            var value_grupo = $("#value_grupo").val();
            $("#role_clave").val(value_role);
            $("#grupo_id").val(value_grupo);
            ...
            function load_users(){
                ...
                var value_usuario_ids = $("#value_usuario_ids").val();
                obj                   = value_usuario_ids.split(',');
                ...
                $.ajax({
                   ...
                   success:  function (response) {
                        ...
                        $.each(obj, function(i,e){
                            $("#usuario_ids option[value='" + e + "']").prop("selected", true);
                        });
                   },
                   statusCode: {
                      404: function() {

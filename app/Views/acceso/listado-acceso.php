                                        ...
                                        <tbody>
                                            <?php foreach($resultado_busqueda as $rb) { ?>
                                                <tr>
                                                    ...
                                                    <td scope="col">
                                                        <a href="<?php echo base_url('public/Acceso/editar_acceso/'.$rb->rol.";".$rb->oid_grupo); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Editar</a>
                                                        <a hidden="" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-danger btn-sm" aria-label="" onclick='botonEliminar()'>Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>  

...
<body>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->oid ?>', '<?= $rb->sede_nombre ?>', 
                        ...
                        '<a href="<?php echo site_url('sede/editar/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Editar</a>']);
            console.log('<?=$rb->inactivo?>')
        <?php } ?>
    ...
    <script>
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('public/sede/eliminar_sede'); ?>";

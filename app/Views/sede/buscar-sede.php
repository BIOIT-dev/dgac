                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" name="sede_search" id="sede_search" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="sede_nombre" class="col-sm-3 text-right control-label col-form-label">Nombre Sede</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="sede_nombre" id="sede_nombre" placeholder="Nombre Sede">
                                        </div>
                                    </div>
                                </div>
                                <hr>

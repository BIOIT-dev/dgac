                            ...
                            <form class="form-horizontal" name="documento_search" id="documento_search" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="tiar_nombre" class="col-sm-3 text-right control-label col-form-label">Nombre Documento</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="tiar_nombre" id="tiar_nombre" placeholder="Nombre Documento">
                                        </div>
                                    </div>
                                </div>
                                <hr>

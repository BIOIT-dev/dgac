...
<body>
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('documento/buscar'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->oid ?>', '<?= $rb->tiar_nombre ?>', 
                        '<?= ($rb->tiar_obligatorio==0)?'<span class="badge py-1 badge-danger">No obligatorio</span>':'<span class="badge py-1 badge-success text-white">Obligatorio</span>' ?>',
                        '<?= ($rb->vige_cod==1)?'<span class="badge py-1 badge-danger">No vigente</span>':'<span class="badge py-1 badge-success text-white">Vigente</span>' ?>',
                        '<a href="<?php echo site_url('documento/editar/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Editar</a>']);
        <?php } ?>
    ...
    <script>
        function modalSwal(){
            ...
            if (cant_usuarios_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_usuarios_checked+" documentos? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('public/documento/eliminar'); ?>";

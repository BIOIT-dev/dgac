                                ...
                                <div class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto;">
                                    ...
                                    <div class="swal2-content">
                                        ...
                                        <div class="swal2-actions" style="display: flex;">
                                            <a href="<?php echo site_url('encuesta/editar/'.$oid_creado); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                            <a href="<?php echo site_url('profile/administracion'); ?>" type="button" class="swal2-cancel swal2-styled" aria-label="">Cancelar</a>

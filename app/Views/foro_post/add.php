            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('public/Post/add/'.$oid_foro); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="asunto" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <input type="radio" checked="" id="zona_home_1" name="zona_home[]" class="material-inputs filled-in chk-col-pink" value="1">
                                            <label for="zona_home_1">No mostrar</label>
                                            <br>
                                            <input type="radio" id="zona_home_2" name="zona_home[]" class="material-inputs filled-in chk-col-pink" value="2">
                                            <label for="zona_home_2">En la Zona de Reflexión</label>
                                            <br>
                                            <input type="radio" id="zona_home_3" name="zona_home[]" class="material-inputs filled-in chk-col-pink" value="3">
                                            <label for="zona_home_3">En la Zona de Links</label>
                                            <br>
                                            <input type="radio" id="zona_home_4" name="zona_home[]" class="material-inputs filled-in chk-col-pink" value="4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-control" name="oid_team" id="oid_team">
                                                <option value="0" selected="selected">Disponible para toda la comunidad</option>
                                                <option value="9">Disponible para "adc"</option>
                                                <option value="5">Disponible para "AVSEC AMB"</option>
                                                <option value="7">Disponible para "Curso Inducción"</option>
                                                <option value="1">Disponible para "Encargado E-learning"</option>
                                                <option value="10">Disponible para "test equipo"</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <br>
                                            <input type="checkbox" id="inactivo" name="inactivo" class="material-inputs filled-in chk-col-pink" value="1">

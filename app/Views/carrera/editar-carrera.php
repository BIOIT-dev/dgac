                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/carrera/editar/'.$profile_data_edit['oid']); ?>" name="carrera_crear" id="carrera_crear" method="post" accept-charset="utf-8" class="form-horizontal">
                                        <div class="form-group" hidden>
                                            ...
                                            <div class="form-group">
                                                <small><label class="col-md-12">Nombre de la Carrera</label></small>
                                                <div class="col-md-12">

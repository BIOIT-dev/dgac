            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <!-- <hr> -->
                            <form action="<?php echo base_url('public/indicadoresHistoricos/editar_indicador/'.$edit_indicador['oid']); ?>" name="editar_indicador" id="editar_indicador" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-12 col-lg-6">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="anio" id="anio" class="form-control">
                                                        <?php for($i = date("Y") - 6; $i <= date("Y") - 1; $i++){ ?>
                                                            <option value="<?php echo $i ?>" <?= ($edit_indicador['anio']==$i)?'selected':'' ?> id="anio<?php echo $i ?>"><?php echo $i ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="<?php echo $edit_indicador['nuevos'] ?>" name="nuevos" type="number" min="0" class="form-control" id="nuevos" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="<?php echo $edit_indicador['antiguos'] ?>" name="antiguos" type="number" min="0" class="form-control" id="antiguos" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="<?php echo $edit_indicador['reincorpora'] ?>" name="reincorpora" type="number" min="0" class="form-control" id="reincorpora" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="<?php echo $edit_indicador['total'] ?>" name="total" type="number" min="0" class="form-control" id="total" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('public/CategoriasForos/edit/'.$resultado_busqueda->oid); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="nombre" value="<?=$resultado_busqueda->nombre?>" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <label for="global">Ver en todas las comunidades</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">

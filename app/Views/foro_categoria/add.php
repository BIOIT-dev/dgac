            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('public/CategoriasForos/add/'); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="nombre" value="" type="text" class="form-control" required>
                                        </div>
                                    </div>

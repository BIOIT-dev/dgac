...
<body>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table name="tabla_registros" id="tabla_registros" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <a href="<?php echo site_url($controller_name.'/method/add'); ?>" class="btn waves-effect waves-light  btn-outline-info btn-sm m-1 ml-0"
                                        >Agregar</a>
                                        <thead>
                                            <tr>
                                                <th></th>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->oid ?>', '<?= $rb->nombre ?>','<?= $rb->fecha ?>','<?= $rb->fecha ?>',

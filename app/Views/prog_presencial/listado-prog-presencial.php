...
<body>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay carreras seleccionados para eliminar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('carrera/buscar_carrera'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->nombre ?>', '<?= $rb->duracion ?>', '<?= $rb->horas ?>',
                        '<?= ($rb->inactivo==1)?'<span class="badge py-1 badge-danger">Inactivo</span>':'<span class="badge py-1 badge-success text-white">Activo</span>' ?>',
                        '<a href="<?php echo site_url('progPresencial/editar/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Editar</a>\
                        <a target="_blank" href="<?php echo site_url('progPresencial/reporte_asignaturas/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Reporte Asignaturas</a>\
                        <a target="_blank" href="<?php echo site_url('progPresencial/reporte_contenidos/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Reporte Contenidos</a>']);
        <?php } ?>
    ...
    <script>
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('public/carrera/eliminar_carrera'); ?>";

        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card ">
                            <form action="<?php echo base_url('public/reportePresupuestario/editar/'.$data_edit['oid']) ?>" name="editar" id="editar" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="form-body">
                                    <div class="card-body">
                                        <div class="card-body">
                                            <h5 class="card-title">Editar Presupuesto</h5>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input name="cohorte" id="cohorte" value="<?= $data_edit['cohorte'] ?>" type="text" class="form-control" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input name="monto" id="monto" value="<?= $data_edit['monto'] ?>" type="text" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

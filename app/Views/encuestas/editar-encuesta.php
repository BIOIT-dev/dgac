            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <!-- <hr> -->
                            <form action="<?php echo base_url('public/encuestas/editar/'.$data_edit['oid']); ?>" name="add_encuesta" id="add_encuesta" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Agregar Encuesta de Observación</h4>
                                    <div class="form-group row">
                                        <label for="titulo" class="col-md-2 col-form-label">Titulo</label>
                                        <div class="col-sm-10">
                                            <input name="titulo" type="text" class="form-control" id="titulo" value="<?= $data_edit['titulo'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="titulo" class="col-md-2 col-form-label">Encuesta</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="<?= $r_encuesta->titulo ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="porcentaje" class="col-md-2 col-form-label">Porcentaje Rendimiento</label>
                                        <div class="col-md-2">
                                            <input name="porcentaje" type="number" min="0" max="100" class="form-control" id="porcentaje" value="<?= $data_edit['porcentaje'] ?>">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="disponible" id="disponible" class="form-control">
                                                <option value="1" <?= ($data_edit['disponible']=="1" ? "selected" : "") ?>>Disponible</option>
                                                <option value="0" <?= ($data_edit['disponible']=="0" ? "selected" : "") ?>>No Disponible</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="f_desde" type="date" min="<?= date("Y-m-d", strtotime($data_edit['f_desde'])) ?>" max="" class="form-control" id="f_desde" value="<?= date("Y-m-d", strtotime($data_edit['f_desde'])) ?>" onchange="validarFecha('inicio')" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="f_hasta" type="date" min="<?= date("Y-m-d", strtotime($data_edit['f_desde'])) ?>" max="" class="form-control" id="f_hasta" value="<?= date("Y-m-d", strtotime($data_edit['f_hasta'])) ?>" onchange="validarFecha('termino')" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-10">
                                            <select name="agno" id="agno" class="form-control">
                                                <?php for($i = date("Y"); $i >= "1950"; $i--){ ?>
                                                    <option value="<?php echo $i ?>" <?= ($data_edit['agno']==$i ? "selected" : "") ?>><?php echo $i ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="semestre" id="semestre" class="form-control" required>
                                                ...
                                                <option value="1" <?= ($data_edit['semestre']=="1" ? "selected" : "") ?>>Primer Semestre</option>
                                                <option value="2" <?= ($data_edit['semestre']=="2" ? "selected" : "") ?>>Segundo Semestre</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="oid_curso" id="oid_curso" class="form-control" onchange="cargarProfesores()" required>
                                                ...
                                                <?php foreach($r_asignaturas as $ra) { ?>
                                                    <option value="<?php echo $ra->oid ?>" id="oid_curso<?php echo $ra->oid ?>" <?= ($data_edit['oid_curso']==$ra->oid ? "selected" : "") ?>><?php echo $ra->titulo ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>

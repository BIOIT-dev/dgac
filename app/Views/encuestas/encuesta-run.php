                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                    <div class="">
                                        <form class="form-horizontal" action="<?php echo base_url('public/encuestas/encuestarun/'.$profile_data_edit['oid']); ?>" name="encuestarun" id="encuestarun" method="post" accept-charset="utf-8">

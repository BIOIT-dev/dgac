...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="scrollable" style="height:100%;">
                        <div class="p-3">
                            <a id="compose_mail" class="waves-effect waves-light btn btn-danger d-block" href="<?php echo base_url('public/Mensajeria/new'); ?>">Redactar</a>
                        </div>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item border-0 p-0">
                                <a href="<?=site_url('Mensajeria/inbox');?>" class="<?=($box=='inbox')?'active':''?> list-group-item-action d-block"><i class="font-18 align-middle mr-1 mdi mdi-inbox"></i> Mis mensajes <!--<span class="badge py-1 badge-success float-right">6</span>--></a>
                            </li>
                            <li class="list-group-item border-0 p-0">
                                <a href="<?=site_url('Mensajeria/sendbox');?>" class="<?=($box=='sendbox')?'active':''?> list-group-item-action d-block"> <i class="font-18 align-middle mr-1 mdi mdi-star"></i> Mensajes enviados </a>
                            </li>
                            <li class="list-group-item border-0 p-0">
                                <a href="#" class="<?=($box=='mailbox')?'active':''?> list-group-item-action d-block"> <i class="font-18 align-middle mr-1 mdi mdi-star"></i> Correos enviados </a>
                            </li>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                            <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                                ...
                                                <div class="swal2-content">
                                                    <div id="swal2-content" style="display: block;">
                                                        No hay mensajes seleccionados para eliminar
                                                    </div>
                                                    <div class="swal2-actions" style="display: flex;">
                                        ...
                                        <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                            <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                                ...
                                                <div class="swal2-content">
                                                    ...
                                                    <div class="swal2-actions" style="display: flex;">
                                                        <a href="<?php echo site_url('mensajeria/inbox'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                        <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            <?
            $sec = strtotime($rb->fecha);  
            //converts seconds into a specific format  
            $newdate = date ("Y/d/m", $sec);  
            ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $newdate ?>', '<?= $rb->nombres ?>', 
                        '<?= substr(strip_tags($rb->texto),0,50) ?>',
                        '<a href="<?php echo site_url('mensajeria/ver/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Ver</a>']);
            // console.log(dataSet)
        <?php } ?>
    ...
    <script>
        function modalSwal(){
            ...
            if (cant_usuarios_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_usuarios_checked+" mensajes? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('public/Mensajeria/delete_messages'); ?>";

                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="" >
                                <div class="" id="" role="" aria-labelledby="">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/admisionCarrera/editar/'.$profile_data_edit['oid']); ?>" name="editar_carrera_inactivo" id="editar_carrera_inactivo" method="post" accept-charset="utf-8" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-general-tab" data-toggle="pill" href="#general-tab-table" role="tab" aria-controls="pills-timeline" aria-selected="true">Datos Generales</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profesores-tab" data-toggle="pill" href="#profesores-tab-table" role="tab" aria-controls="pills-profile" aria-selected="false">Profesores</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-asignaturas-tab" data-toggle="pill" href="#asignaturas-tab-table" role="tab" aria-controls="pills-setting" aria-selected="false">Asignaturas</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-examenes-tab" data-toggle="pill" href="#examenes-tab-table" role="tab" aria-controls="pills-setting" aria-selected="false">Exámenes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-carreras-tab" data-toggle="pill" href="#carreras-tab-table" role="tab" aria-controls="pills-setting" aria-selected="false">Carreras</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-postulantes-tab" data-toggle="pill" href="#postulantes-tab-table" role="tab" aria-controls="pills-setting" aria-selected="false">Postulantes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-matriculados-tab" data-toggle="pill" href="#matriculados-tab-table" role="tab" aria-controls="pills-setting" aria-selected="false">Matriculados</a>
                                </li>
                            </ul>
                            <!-- Tabs -->
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="general-tab-table" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                ...
                                <div class="tab-pane fade" id="profesores-tab-table" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                ...
                                <div class="tab-pane fade" id="asignaturas-tab-table" role="tabpanel" aria-labelledby="pills-setting-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                        <div class="table-responsive">
                                ...
                                <div class="tab-pane fade" id="examenes-tab-table" role="tabpanel" aria-labelledby="pills-setting-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                        <div class="table-responsive">
                                            <table name="tabla_examenes" id="tabla_examenes" class="table table-striped table-bordered display" style="width:100%">
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-danger btn-sm m-1 ml-0"
                                                                    onclick='modalSwal("tabla_examenes")'>Eliminar Exámen</button>
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm m-1 ml-0"
                                ...
                                <div class="tab-pane fade" id="carreras-tab-table" role="tabpanel" aria-labelledby="pills-setting-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                        <div class="table-responsive">
                                            <table name="tabla_carreras" id="tabla_carreras" class="table table-striped table-bordered display" style="width:100%">
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-danger btn-sm m-1 ml-0"
                                                                    onclick='modalSwal("tabla_carreras")'>Eliminar Carrera</button>
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm m-1 ml-0"
                                ...
                                <div class="tab-pane fade" id="postulantes-tab-table" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                        <div class="table-responsive">
                                            <table name="tabla_postulantes" id="tabla_postulantes" class="table table-striped table-bordered display" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">ID</th>
                                                        <th scope="col">RUT</th>
                                ...
                                <div class="tab-pane fade" id="matriculados-tab-table" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <div class="card-body">
                                        <!-- Start table -->
                                        <div class="table-responsive">
                                            <table name="tabla_matriculados" id="tabla_matriculados" class="table table-striped table-bordered display" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">ID</th>
                                                        <th scope="col">RUT</th>
    ...
    <script>
        ...
        <?php foreach($r_profesores as $rp) { ?>
            dataProfesores.push(['<?= $rp->oid ?>', '<?= $rp->oid ?>','<?= $rp->rut ?>','<?= $rp->nombres ?>','<?= $rp->apellido_paterno ?>','<?= $rp->apellido_materno ?>',    
                        ...
                        '<button onclick="cambiarVigencia('+'<?= $rp->oid.','.$rp->inactivo ?>'+')" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Vigencia</button>']);
        <?php } ?>
        crearDataTable('#tabla_profesores', dataProfesores);
        ...
        <?php } ?>
        crearDataTable('#tabla_asignaturas', dataAsignaturas);

        //Dataset para crear la tabla Examenes
        var dataExamenes = []
        <?php foreach($r_examenes as $rexamenes) { ?>
            dataExamenes.push(['<?= $rexamenes->grupos_preguntas_id ?>', '<?= $rexamenes->grupos_preguntas_id ?>','<?= $rexamenes->preg_nombre ?>',
                        // '<button onclick="cambiarVigencia('+'<?= $rexamenes->oid.','.$rexamenes->preg_activo ?>'+')" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Vigencia</button>'
                    ]);
        <?php } ?>
        crearDataTable('#tabla_examenes', dataExamenes);

        //Dataset para crear la tabla Carreras
        var dataCarreras = []
        <?php foreach($r_carreras as $rcarreras) { ?>
            dataCarreras.push(['<?= $rcarreras->oid ?>', '<?= $rcarreras->oid ?>','<?= $rcarreras->nombre ?>', '<?= $rcarreras->duracion ?>','<?= $rcarreras->horas ?>',
                        '<?= ($rcarreras->inactivo==1)?'<span class="badge py-1 badge-danger">Inactivo</span>':'<span class="badge py-1 badge-success text-white">Activo</span>' ?>',
                        '<a href="<?php echo site_url('progPresencial/editar/'.$rcarreras->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Editar</a>']);
        <?php } ?>
        crearDataTable('#tabla_carreras', dataCarreras);

        //Dataset para crear la tabla Alumnos
        var dataPostulantes = []
        <?php foreach($r_postulantes as $rpostulantes) { ?>
            dataPostulantes.push(['<?= $rpostulantes->postulacion_oid ?>','<?= $rpostulantes->rut ?>','<?= $rpostulantes->apellido_paterno ?>','<?= $rpostulantes->apellido_materno ?>',
                        '<span class="badge py-1 badge-success text-white"><?= $rpostulantes->poes_nombre ?></span>',
                        ]);
        <?php } ?>
        crearTablaSimple('#tabla_postulantes', dataPostulantes);

        //Dataset para crear la tabla Alumnos
        var dataMatriculados = []
        <?php foreach($r_matriculados as $rmatriculados) { ?>
            dataMatriculados.push(['<?= $rmatriculados->postulacion_oid ?>','<?= $rmatriculados->rut ?>','<?= $rmatriculados->apellido_paterno ?>','<?= $rmatriculados->apellido_materno ?>',
                        '<span class="badge py-1 badge-success text-white"><?= $rmatriculados->poes_nombre ?></span>',
                        ]);
        <?php } ?>
        crearTablaSimple('#tabla_matriculados', dataMatriculados);
        /******************************************************************/
        /******************************************************************/

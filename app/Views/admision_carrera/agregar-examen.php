...
<body>
                                ...
                                <div class="table-responsive">
                                    <table name="tabla_examenes" id="tabla_examenes" class="table table-striped table-bordered display" style="width:100%">
                                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm m-1 ml-0"
                                                            onclick='modalSwal()'>Agregar Exámenes</button>
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th scope="col">ID</th>
                                        ...
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    ...
                                                    <button onclick="botonAgregar()" type="button" class="swal2-confirm swal2-styled" aria-label="">Agregar</button>
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay profesores seleccionados para agregar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
    ...
    <script>
        ...
        var dataSet = []
        <?php foreach($r_examenes as $rp) { ?>
            dataSet.push(['<?= $rp->oid ?>', '<?= $rp->oid ?>','<?= $rp->preg_nombre ?>','<?= $rp->preg_activo ?>']);
        <?php } ?>
        ...
        function checkboxTest(){
            var checked = [];
            var list_checked = $('#tabla_examenes').DataTable().column(0).checkboxes.selected();
    ...
    <script>
        function modalSwal(){
            cant_usuarios_checked = $('#tabla_examenes').DataTable().column(0).checkboxes.selected().length;
            //console.log(cant_usuarios_checked);//

            if (cant_usuarios_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "Agregarás "+cant_usuarios_checked+" exámen"+(cant_usuarios_checked>1?'es':'');
        ...
        function botonAgregar(){
            ...
            var url = "<?php echo base_url('public/admisionCarrera/agregar_examen/'.$oid_grupo); ?>";
            console.log(url);
            $.post(url, checked, function(data, status){
                // console.log("CARGANDO!", data, status);
                if (status){
                    window.location = "<?php echo base_url('public/admisionCarrera/editar/'.$oid_grupo); ?>";
                    // document.querySelector("#modalDelete").style.display = "none";

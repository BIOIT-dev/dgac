                            ...
                            <form class="form-horizontal" name="carrera_search" id="carrera_search" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                    <!-- <div class="form-group row">
                                        <label for="userid" class="col-sm-3 text-right control-label col-form-label">Seleccionar Periodo</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre Carrera">
                                        </div>
                                    </div> -->
                                    <div class="form-group row">

                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('public/GeneradorDocs/index'); ?>" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="nombre" name="nombre" class="form-control">
                                                <?php foreach($query as $que) { ?>
                                                    <option value="<?php echo $que->nombre; ?>">
                                                        <?php echo $que->nombre." > ".$que->url; ?>        
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>

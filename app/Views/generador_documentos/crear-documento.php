                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true">Documento</a>
                                </li>
                                <!-- <li class="nav-item">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                            ...
                                            ?>
                                        <form action="<?php echo base_url('public/GeneradorDocs/crear_documento'); ?>" name="crear_documento" id="crear_documento" method="post" accept-charset="utf-8" class="form-horizontal form-material">

                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                            ...
                                            ?>
                                        <form action="<?php echo base_url('public/GeneradorDocs/reporte_asuncion'); ?>" name="generar_reporte" id="generar_reporte" method="post" accept-charset="utf-8" class="form-horizontal form-material">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row mt-5">
                                                        <div class="col-md-6">
															<label for="cbx_Profesores">Profesores</label>
                                                            <div name="cbx_Profesores" id="cbx_Profesores" style="height:10em;width: 22em;margin-left:1em ">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12 text-center">
                                                    <button type="submit" class="btn btn-success">Imprimir reporte de asunción</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div> 

...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('public/GeneradorDocs/crear_documento') ?>" type="button" class="btn btn-info waves-effect waves-light">Nuevo</a>

                                    <table name="tabla_documento" id="tabla_documento" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Moduloid</th>
                                        ...
                                        <tbody>
                                            <?php foreach($resultado_busqueda as $rb) { ?>
                                                <tr>
                                                    <td scope="col"><?php echo $rb->id; ?></td>
                                                    <td scope="col"><?php echo $rb->nombre; ?></td>
                                                    <td scope="col">
                                                        <a href="<?php echo base_url('public/GeneradorDocs/editar_documento/'.$rb->id); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Editar</a>
                                                        <a target="_blank" href="<?php echo base_url('public/'.$rb->url); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Generar</a>
                                                        <a type="button" class="btn waves-effect waves-light btn-rounded btn-outline-danger btn-sm" aria-label="" onclick='botonEliminar2("<?php echo $rb->id; ?>")'>Eliminar</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>  
                                        ...
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    ...
                                                    <button onclick="botonEliminar2()" type="button" class="swal2-confirm swal2-styled" aria-label="">Eliminar</button>
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay Documento seleccionado para eliminar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('GeneradorDocs/index'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#tabla_documento').DataTable({
                select: {
                    style: 'multi'
                },
                order: [[1, 'asc']],
        ...
        // Se envían todos los id de documentos a ser eliminados
        function checkboxTest(){
            var checked = [];
            var list_checked = $('#tabla_documento').DataTable().column(0).checkboxes.selected();
    ...
    <script>
        function modalSwal(){
            cant_modulo_checked = $('#tabla_documento').DataTable().column(0).checkboxes.selected().length;
            //console.log(cant_modulo_checked);//

            if (cant_modulo_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_modulo_checked+" roles? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar2(id){
            var checked = {};
            // var list_checked = $('#tabla_modulo').DataTable().column(0).checkboxes.selected();
            // for (var i = 0; i < list_checked.length; i++){
            //     // checked.push(list_checked[i]);
            ...
            var url = "<?php echo base_url('public/GeneradorDocs/eliminar_documento'); ?>";

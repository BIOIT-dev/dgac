            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('public/'.$controller_name.'/method/add/'); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="dia" value="" type="date" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12" >Dia</label>
                                        <div class="col-md-12">
                                            <input size="50" name="hora" value="" type="time" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="descripcion" value="" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">

...
<body>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table name="tabla_registros" id="tabla_registros" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <a href="<?php echo site_url($controller_name.'/method/add'); ?>" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm m-1 ml-0"
                                        >Agregar</a>
                                        <thead>
                                            <tr>
                                                <th></th>
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url($controller_name.'/method/index'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->oid ?>', '<?= $rb->titulo ?>','<?= $rb->dia ?>','<?= $rb->hora ?>',

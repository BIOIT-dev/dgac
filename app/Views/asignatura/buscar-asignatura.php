                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" name="asignatura_search" id="asignatura_search" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="userid" class="col-sm-3 text-right control-label col-form-label">Asignatura</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="asignatura" id="asignatura" placeholder="Nombre Asignatura">
                                        </div>
                                    </div>
                                </div>
                                <hr>

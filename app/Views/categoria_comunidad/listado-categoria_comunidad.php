...
<body>
                                ...
                                <div class="table-responsive">
                                    <table name="tabla_carreras" id="tabla_carreras" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Comunidades Asociadas</th>
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay categorías de carrera seleccionados para eliminar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    ¡Categorías de Comunidad eliminadas correctamente!
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('categoriaComunidad/buscar_categoria_comunidad'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->nombre ?>', '<?= $rb->cnt ?>',
                        '<a href="<?php echo site_url('categoriaComunidad/editar/'.$rb->oid); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label=""">Editar</a>']);
            // console.log(dataSet)
        <?php } ?>
    ...
    <script>
        function modalSwal(){
            ...
            if (cant_usuarios_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_usuarios_checked+" categorias de comunidad? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('public/categoriaComunidad/eliminar'); ?>";

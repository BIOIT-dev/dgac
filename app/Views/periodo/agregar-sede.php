                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- <hr> -->
                            <form action="<?php echo base_url('public/periodo/agregar_sede/'.$id_periodo); ?>" name="agregar_sede" id="agregar_sede" method="post" accept-charset="utf-8" class="form-horizontal">
                                <div class="card-body">
                                    <h4 class="card-title">Crear Sede</h4>
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-6" hidden>
                                            <div class="form-group row">
                                                <label for="inactivo" class="col-sm-3 text-right control-label col-form-label">Inactivo</label>
                                                <div class="col-sm-9">
                                                    <input value="0" name="inactivo" type="text" class="form-control" id="inactivo" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input name="sede_nombre" type="text" class="form-control" id="sede_nombre" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

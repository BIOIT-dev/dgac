                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="<?php echo base_url('public/Roles/buscar_roles'); ?>" method="post" accept-charset="utf-8">
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="name" name="name" class="form-control">
                                                <?php foreach($query as $que) { ?>
                                                    <option value="<?php echo $que->name ?>"><?php echo $que->name ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-0 text-right">
                                        <a href="<?php echo base_url('public/Roles/crear_role') ?>" type="button" class="btn btn-info waves-effect waves-light">Nuevo</a>

...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-0 text-right">
                                    <a href="<?php echo base_url('public/Roles/crear_role') ?>" type="button" class="btn btn-info waves-effect waves-light">Nuevo Role de Usuario</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table name="tabla_roles" id="tabla_roles" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php foreach($resultado_busqueda as $rb) { ?>
                                                <tr>
                                                    ...
                                                    <td scope="col"><?php echo $rb->name; ?></td>
                                                    <td scope="col"><?php echo $rb->clave; ?></td>
                                                    <td scope="col">
                                                        <a href="<?php echo base_url('public/Roles/editar_role/'.$rb->id); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Editar Rol</a>
                                                        <a href="<?php echo base_url('public/Roles/gestionmodulos/'.$rb->id); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Gestionar Modulos</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>  
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay roles seleccionados para eliminar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('Roles/buscar_roles'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function checkboxTest(){
            var checked = [];
            var list_checked = $('#tabla_roles').DataTable().column(0).checkboxes.selected();
    ...
    <script>
        function modalSwal(){
            cant_roles_checked = $('#tabla_roles').DataTable().column(0).checkboxes.selected().length;
            //console.log(cant_roles_checked);//

            if (cant_roles_checked > 0){
                document.querySelector("#modalDelete #swal2-content").innerHTML = "¿Está seguro que quiere eliminar "+cant_roles_checked+" roles? <br>¡Esta acción no se puede deshacer!";
        ...
        function botonEliminar(){
            ...
            var url = "<?php echo base_url('Roles/eliminar_role'); ?>";

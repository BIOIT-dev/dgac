...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group mb-0 text-right">
                                    <a href="<?php echo base_url('public/Modulo/crear_modulo') ?>" type="button" class="btn btn-info waves-effect waves-light">Nuevo</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table name="tabla_modulo" id="tabla_modulo" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php foreach($resultado_busqueda as $rb) { ?>
                                                <tr>
                                                    ...
                                                    <td scope="col"><?php echo $rb->url; ?></td>
                                                    <td scope="col">
                                                        <a href="<?php echo base_url('public/Modulo/editar_modulo/'.$rb->id); ?>" type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success btn-sm" aria-label="">Editar</a>
                                    ...
                                    <div id="modalError" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                <div id="swal2-content" style="display: block;">
                                                    No hay Modulo seleccionado para eliminar
                                                </div>
                                                <div class="swal2-actions" style="display: flex;">
                                    ...
                                    <div id="modalSuccess" class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto; display: none;">
                                        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                                            ...
                                            <div class="swal2-content">
                                                ...
                                                <div class="swal2-actions" style="display: flex;">
                                                    <a href="<?php echo site_url('Modulo/buscar_modulo'); ?>" type="button" class="swal2-confirm swal2-styled" aria-label="" style="display: inline-block; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214);">OK</a>
                                                    <!-- <button onclick="modalClose()" type="button" class="swal2-confirm swal2-styled" aria-label="">OK</button> -->
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        // Se envían todos los id de roles a ser eliminados
    ...
    <script>
        function modalSwal(){
            cant_modulo_checked = $('#tabla_modulo').DataTable().column(0).checkboxes.selected().length;
        ...
        function botonEliminar2(id){
            ...
            var url = "<?php echo base_url('public/Modulo/eliminar_modulo'); ?>";

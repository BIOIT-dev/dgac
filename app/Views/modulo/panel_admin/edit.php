            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('public/modulo/panel_admin/edit/'.$resultado_busqueda->id); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                    <div class="form-group" hidden>
                                        <label class="col-md-12">oid</label>
                                        <div class="col-md-12">
                                            <input name="id" type="text" class="form-control" value="<?= $resultado_busqueda->id ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input size="50" name="name" value="<?= $resultado_busqueda->name ?>" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Orden</label>
                                        <div class="col-md-12">
                                            <input size="50" name="orden" value="<?= $resultado_busqueda->orden ?>" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">

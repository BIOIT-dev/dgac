                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/cursos/add_objeto_aprendizaje/'.$oid_curso); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input size="50" name="titulo" value="<?php if(isset($cursos_scorm->titulo)){echo $cursos_scorm->titulo;}?>" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Texto</label>
                                                <div class="col-md-12">
                                                    <textarea size="50" name="texto" class="form-control">
                                                    <?php if(isset($cursos_scorm->texto)){echo $cursos_scorm->texto;}?>
                                                    </textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Objeto de aprendizaje</label>
                                                <div class="col-md-12">
                                                <select name="oid_sco" class="form-control">
                                                    <option>Seleccione un objeto de aprendizaje</option>
                                                    <? foreach($cursos_objeto_aprendizaje  as $valor){?>
                                                        <option value="<?=$valor->oid?>"><?= $valor->titulo ?>-<?=$valor->oid?></option>
                                                    <? }?>
                                                </select>
                                                </div>
                                            </div>

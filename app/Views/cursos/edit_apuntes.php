                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/cursos/edit_apuntes/'.$oid_curso."/".$oid_apunte); ?>" name="add_etiqueta" enctype="multipart/form-data" id="add_etiqueta" method="post" accept-charset="utf-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input size="50" name="titulo" value="<?= $apunte_edit[0]['titulo'] ?>" type="text" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Texto</label>
                                                <div class="col-md-12">
                                                    <textarea size="50" name="texto" class="form-control" required><?= $apunte_edit[0]['texto'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Archivo</label>
                                                <div class="col-md-12">
                                                    <a type="button" href="<?php echo base_url('assets/uploads/apuntes/'.$apunte_edit[0]['archivo']); ?>" class="btn btn-secondary" download><i class="fas fa-download"></i>
                                                            Descargar</a>
                                                </div>
                                            </div>

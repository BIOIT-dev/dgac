                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/cursos/edit_objeto_aprendizaje/'.$oid_curso.'/'.$cursos_scorm->oid); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                            ...
                                            <div class="form-group" hidden>
                                                <label class="col-md-12">oid </label>
                                                <div class="col-md-12">
                                                    <input name="oid" type="text" class="form-control" value="<?= $cursos_scorm->oid ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Título</label>
                                                <div class="col-md-12">
                                                    <input size="50" name="titulo" value="<?php if(isset($cursos_scorm->titulo)){echo $cursos_scorm->titulo;}?>" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                <input type="hidden" value="<?echo $cursos_scorm->oid_sco;?>" name="oid_sco">
                                                <?echo $cursos_scorm->ss_objeto;?>
                                                </div>
                                            </div>
                                            <div class="form-group">

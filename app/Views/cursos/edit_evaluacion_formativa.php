                    ...
                    <div id="accordion" class="custom-accordion mb-4">
                        <div class="card mb-0">
                            ...
                            <div id="collapseThree" class="" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body">
                                    <form action="<?php echo base_url('public/cursos/edit_evaluaciones/'.$oid_curso."/".$oid_evaluacion); ?>" name="edit_evaluaciones_3" id="edit_evaluaciones_3" method="post" accept-charset="utf-8">

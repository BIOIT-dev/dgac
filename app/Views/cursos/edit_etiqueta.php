                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/cursos/edit_etiqueta/'.$oid_curso.'/'.$etiqueta_detalle->oid); ?>" name="add_etiqueta" id="add_etiqueta" method="post" accept-charset="utf-8">
                                            ...
                                            <div class="form-group" hidden>
                                                <label class="col-md-12">oid grupo</label>
                                                <div class="col-md-12">
                                                    <input name="oid" type="text" class="form-control" value="<?php echo $etiqueta_detalle->oid; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Título</label>
                                                <div class="col-md-12">
                                                    <input size="50" name="titulo" value="<?php echo $etiqueta_detalle->titulo; ?>" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">

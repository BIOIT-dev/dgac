                                    ...
                                    <div class="card-body">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12">
                                                            <div class="alert alert-success">Agregar MicroSitio</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <form action="<?php echo base_url('public/bibliotecas/biblioMicroSitioAdd/'.$oid_categoria) ?>" method="POST"  enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label for="archivo">Archivo ZIP</label><br>
                                                        <input required="" type="file" name="archivo" accept="file/zip">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label for="descripcion">Ancho Ventana</label><br>
                                                        <input required="" class="form-control" type="text" name="win_ancho" value="640">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label for="descripcion">Alto Ventana</label><br>
                                                        <input required="" class="form-control" type="text" name="win_alto" value="480">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <label for="descripcion">Notificar</label><br>

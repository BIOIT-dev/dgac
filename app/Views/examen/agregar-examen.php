                        ...
                        <div class="card">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="current-month" role="tabpanel" aria-labelledby="pills-timeline-tab">
                                    <div class="card-body">
                                        <form action="<?php echo base_url('public/examen/crear'); ?>" name="examen_create" id="examen_create" method="post" accept-charset="utf-8" class="form-horizontal form-material">
                                            <div class="form-group">
                                                <small><label class="col-md-12">Pregunta</label></small>
                                                <div class="col-md-12">
                                                    <input name="preg_nombre" type="text" placeholder="" class="form-control form-control-line" required >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">

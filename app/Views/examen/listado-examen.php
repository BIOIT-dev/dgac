...
<body>
                                ...
                                <div class="table-responsive">
                                    <table name="tabla_examen" id="tabla_examen" class="table table-striped table-bordered display" style="width:100%">
                                        ...
                                        <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-info btn-sm m-1 ml-0"
                                                            onclick="location.href='<?php echo site_url('examen/crear'); ?>'">Agregar</button>
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th scope="col">ID</th>
    ...
    <script>
        ...
        <?php foreach($resultado_busqueda as $rb) { ?>
            dataSet.push(['<?= $rb->oid ?>', '<?= $rb->oid ?>','<?= $rb->preg_nombre ?>', 
                        '<?= ($rb->preg_activo==1)?'<span class="badge py-1 badge-danger">Inactivo</span>':'<span class="badge py-1 badge-success text-white">Activo</span>' ?>',
